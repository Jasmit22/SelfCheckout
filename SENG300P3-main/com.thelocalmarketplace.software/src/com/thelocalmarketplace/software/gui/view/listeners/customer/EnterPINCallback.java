...
/**
 * Listens when customer inputs a PIN code into Insert PIN for Debit
 * 
...
public class EnterPINCallback implements INumpadCallback {

	private ISelfCheckoutStationSoftware logic;

	
    public EnterPINCallback(ISelfCheckoutStationSoftware logic) {
        this.logic = logic;
    }

    @Override
    public void onEnterPressed(String sequence) {
    	this.logic.getCardPaymentLogic().recordPIN(sequence);
    }
}
